...
export const setIsFetchingAC = (value:boolean):SetIsFetchingACType => ({ type: SET_IS_FETCHING_SEARCH_REDUCER, payload: {value} })
...
export type SetIsFetchingACType = { type: typeof SET_IS_FETCHING_SEARCH_REDUCER, payload: { value: boolean }}
